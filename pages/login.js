...
export default function Login() {
  ...
  return (
    <>
      <Head>
        <title>Login - FounderX</title>
        <meta name="description" content="Welcome back to FounderX. Log in to continue building with your AI cofounder." />
        ...
        <header className="px-6 py-6">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/signup" className="text-white hover:text-[#38E4AE] transition-colors">
                Sign Up
              </Link>
            ...
            <div className="space-y-8">
              ...
              <div className="text-white">
                <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                  Welcome Back to<br />
                  <span className="text-[#38E4AE]">FounderX</span>
                </h1>
                <p className="text-xl text-white/90 leading-relaxed">
                  Log in to continue building with your AI cofounder.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#6C63FF] text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-[#5A52E5] hover:shadow-lg hover:shadow-[#6C63FF]/25 transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <div className="text-center">
                    <Link href="/forgot-password" className="text-sm text-[#6C63FF] hover:text-[#5A52E5] transition-colors">
                      Forgot password?
                    </Link>
                  </div>
                </form>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl">
                  <div className="aspect-square bg-gradient-to-br from-white/20 to-white/5 rounded-xl flex items-center justify-center">
                    <div className="text-center text-white">
                      ...
                      <div className="text-lg font-semibold mb-2">AI Dashboard Access</div>
                      <div className="text-sm opacity-80">Opening your startup workspace</div>
                      <div className="mt-4 w-32 h-20 bg-white/20 rounded-lg mx-auto flex items-center justify-center">
                        <div className="grid grid-cols-2 gap-1">
                          <div className="w-3 h-3 bg-[#38E4AE] rounded-full"></div>
