-- Supabase Migration: Add payment fields to users table
...
/*
INSERT INTO users (id, email, plan, status, stripe_customer_id, subscription_id)
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'test1@example.com', 'free', 'active', NULL, NULL),
  ('00000000-0000-0000-0000-000000000002', 'test2@example.com', 'pro', 'active', 'cus_test123', 'sub_test123'),
  ('00000000-0000-0000-0000-000000000003', 'test3@example.com', 'premium', 'active', 'cus_test456', 'sub_test456'),
  ('00000000-0000-0000-0000-000000000004', 'test4@example.com', 'pro', 'canceled', 'cus_test789', 'sub_test789');
*/
